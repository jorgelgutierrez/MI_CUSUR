...
public class Fragment_Inicio_InfoAlumno extends Fragment {
    ...
    TextView codigo, nombre, situacion, nivel, admision, ultimociclo, carrera, centro, sede, creditos, creditosmn, creditosmx, creditosp, promedio;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        creditosmx = (TextView) view.findViewById(R.id.info_alumno_creditos_maximos);
        creditosp = (TextView) view.findViewById(R.id.info_alumno_porcentaje_creditos);
    ...
    private class ConsultarInfoAlumno extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                creditosmx.setText(arrayjson.getString(11));
                creditosp.setText(arrayjson.getString(12));
                promedio.setText(arrayjson.getString(13));

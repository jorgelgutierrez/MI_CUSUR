...
public class Inicio_Sesion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iniciar_sesion = (Button) findViewById(R.id.inicio_BTIniciar_sesion);
        ...
        ayuda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iramenu = new Intent(Inicio_Sesion.this, Ayuda.class);
    ...
    private class ConsultarUsuario extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                VariablesGlobales Codigo = VariablesGlobales.getInstance();
                Codigo.setCodigo(arrayjson.getString(0));
